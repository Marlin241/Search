...
# Marque (l'arche + la flèche montante) en PNG transparent, hébergée.
# Testé en data URI (base64 inline) d'abord — mais Gmail (web + appli), le
# client visé en priorité par ce produit, retire purement et simplement les
# <img src="data:..."> du corps d'un email : ça ne s'affiche JAMAIS, quel
# que soit le réglage d'affichage des images. Retour à une image hébergée,
# seule option qui peut fonctionner dans Gmail. Généré depuis le même tracé
# que frontend/components/common/LogoMark.tsx.
