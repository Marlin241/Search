...
const NAV_ITEMS = [
  ...
  { href: "/offres", label: "Offres d'emploi", icon: Search },
  { href: "/candidatures", label: "Mes candidatures", icon: Send },
  { href: "/diagnostic", label: "Diagnostic ATS", icon: FileCheck2 },
  { href: "/profil", label: "Mon profil", icon: UserCheck },
];
