...
import type { LetterGenerationResult, LetterTone, PersonalizedDocumentOut } from "@/lib/types";
...
export function LetterGenerationPanel({
  diagnosticId,
  existingLetter,
  token,
}: {
  diagnosticId: number;
  existingLetter?: PersonalizedDocumentOut;
  token: string;
}) {
